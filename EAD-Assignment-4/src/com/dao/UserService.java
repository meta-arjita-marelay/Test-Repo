...
public class UserService {
	...
	public static UserDetails getDetails(String email){
		...
		try (Connection conn = ConnectionFactory.getconnection();
			...
			try {
				...
				userDetails.setUserPassword(resultSet.getString("user_password"));
			}catch (SQLException ex) {
				System.out.println(ex);
			}
		} catch (SQLException e) {
	...
	/*public static void main(String[] args) throws SQLException {
		UserDetails users = UserService.getDetails("arjita101@gmail.com");
	 ...
	 * userDetails.setEmailId("arjita@gail.com"); try { userDetails.setDob(new
	 * SimpleDateFormat("yyyy-mm-dd").parse("1997-02-16")); } catch

...
public class Profile extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		UserDetails user = UserService.getDetails(id);
		...
		out.print("<td align = 'right'><span id = 'username'>"
				...
				+ "</span><a href = 'Login.html'>Logout</a></td>");
		out.print("</tr></table>");
		...
		out.print("<td><a href='UpdateUser?email=" + user.getEmailId()
				+ "&fname=" + user.getFirstName() + "&lname="
				+ user.getLastname() + "&contact=" + user.getConNumber()
				+ "&organization=" + user.getOrgName() + "&dob="
				+ user.getDob() + "'>Edit</a></td></tr>");
		out.print("</table>");
